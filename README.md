...
| Parks Branch FY2026/27 | `registers/Parks_Branch_Transaction_Register_FY2627_v11.xlsx` | Branch 4090000, all sections, FY2026/27 P1-3 at O110-O115. Inherits the PS/WP FY2026/27 analysis line by line and classifies the other sections itself. |
...
- `data/inputs_2026-09-11/` the 27SLACT ledger export and four SE2 exports the branch register was built from; `creditor_histories/` the twenty-six APLEDGER creditor history exports (v4 to v10); `journal_pulls/` the TechOne Document Line Table exports embedded on Journal_Sources; `reconstructions/` the TechOne Document Reconstruction exports embedded on Reconstruction_Sources.
- `reports/` derived reports regenerated from the shipped register: `Unidentified_Contractors_v11.md/.xlsx`, the identification queue with one invoice to sight per supplier series; `Journal_Pull_v11.md/.xlsx`, the rule 21 journal pull list, one row per TechOne document file.
...
## State at v11 (14-Sep-2026)

Register total $4,910,566.68 across 6,683 lines, tied to the ledger export and all four SE2 views; 99 of 99 controls TRUE. 416 sighted lines over 409 invoices. Twenty-six APLEDGER creditor histories embedded (72,596 lines on Creditor_Lines). Confirmed $3,584,556.21; Partial $1,040,797.39; Pending evidence $285,213.08. Contractor unidentified $264,171.42 over 164 lines in 75 series; the queue with one invoice to sight per series is `reports/Unidentified_Contractors_v11.md`.
